...
/* ------------------------------------------------------------------ */
/* Players. The men's and women's teams share one roster.              */
/* ------------------------------------------------------------------ */
...
const playerSeeds: PlayerSeed[] = [
  ['Mohamed Sirajj', 7, 'Outside Hitter', 181, 72, '2006-04-12', PROFILE_IDS.player],
  ['Mariyam Zaha', 3, 'Setter', 169, 60, '2005-09-30', PROFILE_IDS.player2],
  ['Ali Shamaan', 11, 'Middle Blocker', 191, 81, '2005-01-25', PROFILE_IDS.player3],
  ['Aminath Rifga', 5, 'Libero', 162, 54, '2009-06-08'],
  ['Yoosuf Zayan', 9, 'Opposite', 186, 77, '2006-11-14'],
  ['Fathimath Shiuna', 1, 'Setter', 171, 62, '2007-02-19'],
  ['Hawwa Nashwa', 14, 'Outside Hitter', 174, 63, '2008-08-03'],
  ['Adam Naseer', 8, 'Middle Blocker', 189, 79, '2005-12-07'],
  ['Sharufa Ismail', 6, 'Defensive Specialist', 165, 56, '2009-03-22'],
  ['Hussain Areef', 12, 'Opposite', 184, 75, '2006-05-16'],
  ['Aishath Zoya', 4, 'Outside Hitter', 176, 65, '2007-10-09'],
  ['Ismail Nahil', 2, 'Libero', 170, 64, '2005-07-28'],
  ['Ahmed Maail', 10, 'Middle Blocker', 187, 76, '2005-09-11'],
  ['Nashfa Adam', 15, 'Outside Hitter', 173, 62, '2008-01-05'],
];
...
const eventSeeds: EventSeed[] = [
  { title: 'Tuesday practice', type: 'practice', offset: -21, hour: 20, durationH: 2, location: HOME },
  { title: 'Thursday practice', type: 'practice', offset: -19, hour: 20, durationH: 2, location: HOME },
  {
    title: 'Friendly vs Vilimalé VC',
    type: 'match',
    offset: -14,
    hour: 16,
    durationH: 3,
  ...
  { title: 'Tuesday practice', type: 'practice', offset: -14, hour: 20, durationH: 2, location: HOME },
  { title: 'Thursday practice', type: 'practice', offset: -12, hour: 20, durationH: 2, location: HOME },
  {
  ...
  { title: 'Tuesday practice', type: 'practice', offset: -7, hour: 20, durationH: 2, location: HOME },
  { title: 'Thursday practice', type: 'practice', offset: -5, hour: 20, durationH: 2, location: HOME },
  {
  ...
  { title: 'Thursday practice', type: 'practice', offset: 3, hour: 20, durationH: 2, location: HOME },
  {
    title: 'League match vs Malé City VC',
    type: 'match',
    offset: 6,
    hour: 17,
    durationH: 3,
  ...
  { title: 'Tuesday practice', type: 'practice', offset: 8, hour: 20, durationH: 2, location: HOME },
  {
  ...
  { title: 'Thursday practice', type: 'practice', offset: 10, hour: 20, durationH: 2, location: HOME },
  {
    ...
    description:
      'Two days. Pool games on the Saturday, knockouts on the Sunday. Ferry times to follow.',
    isPublic: true,
  },
  {
    ...
    durationH: 3,
    location: YOUTH_CENTRE,
    description: 'End-of-season dinner for both teams. Plus ones welcome.',
    isPublic: true,
  },
];
...
export const seedAnnouncements: Announcement[] = [
  ...
  },
  {
    ...
    body: 'We have Court 1 at the Hulhumalé Sports Complex locked in for Tuesdays and Thursdays, 20:00 to 22:00, for the rest of the season. No more week-to-week uncertainty.\n\nThe complex closes its doors at 22:15, so please help pack down promptly.',
    pinned: false,
    visible_to_roles: [...ALL_ROLES_ARR],
    author_id: PROFILE_IDS.exco,
    author_name: 'Ibrahim Rifau',
  ...
  },
  {
    ...
    body: 'We lost 11 points off serve receive against Vilimalé. That is the single biggest thing between us and a top-three finish.\n\nThe next three practices open with 25 minutes of passing under pressure. It will be repetitive and it will be boring. Do it anyway.',
    pinned: false,
    visible_to_roles: [...ALL_ROLES_ARR],
    author_id: PROFILE_IDS.coach,
    author_name: 'Hassan Niyaz',
...
const financeSeeds: FinanceSeed[] = [
  ...
  [3, 9, 'expense', 'Tournament fees', 'Domestic league entry', 6500],
  ...
  [5, 13, 'expense', 'Travel', 'Ferry and transport, away fixture at Vilimalé', 2400],
  ...
  [7, 25, 'expense', 'Tournament fees', 'Inter-Island Invitational entry', 9000],
