...
- **14 players**, 13 active, across the men's and women's teams, with
  positions, heights, dates of birth, and guardian details for the few who are
  under 18. Three are linked to logins.
- **17 events** across the last three weeks and the next month: practices at
  the Hulhumalé Sports Complex, two matches, the Inter-Island Invitational,
  two ExCo meetings and a squad night. The meetings are committee-only, and a
  few fixtures are flagged public.
...
- **Five announcements**, two pinned, one restricted to the committee.
...
Then sign in as `coach@ube.academy`. Everything appears, Financials and
Manage Accounts included, because the coach owns the academy. Compare that
